const GUIDANCES = [
  ...
  [`console.log("Всегда должна быть конечная цель");\n\nlet array = ["А в нашем", "случае..."];\nconsole.log(array);\n\n// Вы используете консоль чтобы точно понимать\n// в каком состоянии находятся данные и что они из себя представляют.\n// Например, список башен это массив, и получить его можно через game.list\n// Выводя его в консоль Вы увидите его содержимое.\n\nconsole.log("Тем не менее пользоваться консолью совсем необязательно.");`, "О выводе в консоль"],
