...
#### Условия задачи
Вы уже знаете, что такое массив и как получить элемент массива.
Напишите функцию, которая с помощью цикла по одному выведет в консоль каждый элемент массива.  
...
## Итоги
***
1. Программирование старается быть как можно более очевидным для программиста, и хотя чтобы писать программы нужно знать очень много, для простых задач действительно может хватить часа изучения языка
...
Если у вас возникли проблемы с задачей выше, здесь вы найдете ответ к ней со всеми объяснениями — _пусто_
