...
Если у вас возникли проблемы с задачей выше, все ок, она сложная, здесь вы найдете ответ к ней со всеми объяснениями — [решение задачи](https://github.com/zoodogood/piramide/blob/main/resources/homework.md).  
