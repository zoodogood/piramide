...
Если у вас возникли проблемы с задачей выше, всё ок, она сложная.  
Можете здесь получить к ней ответ со всеми объяснениями — [решение задачи](https://github.com/zoodogood/piramide/blob/main/resources/homework.md).  
