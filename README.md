...
Напишите функцию, которая с помощью цикла по одному выведет в консоль все элементы в нём.  
...
Если у вас возникли проблемы с задачей выше, здесь вы найдете ответ к ней со всеми объяснениями — [решение задачи](https://github.com/zoodogood/piramide/new/main/resources).  
