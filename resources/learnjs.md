...
2. Когда вы точно знаете, что сделать следующим, найдите реализацию в интернете. К примеру, _найти элемент массива JS_, приведёт вас к функции find, что будет вам полезна.
3. Не бойтесь пробовать, но неудачи будут, имейте при себе возможность вернуть все у рабочему состоянию.
