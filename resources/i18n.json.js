globalThis.i18nLanguages = {
  ua: {
    ...
    "crashDefender-crash-message": "Якщо все добре, ігноруйте це повідомлення і спокійно натискайте \"Грати!\". Інакше з ймовірністю «99.9%» це був нескінченний цикл."
  },
  ...
  ru: {
    ...
    "crashDefender-crash-message": "Если всё в порядке, проигнорируйте это сообщение и спокойно нажмите кнопку \"Играть!\". Иначе с вероятностью «99,9%» это был бесконечный цикл."
