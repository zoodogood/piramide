globalThis.i18nLanguages = {
  ua: {
    ...
    "footer-article-taskInfo":
      ...
      Отримати масив веж — <code>game.list</code>`,
    ...
    "settings-action-activatePoligon-details":
      ...
      1. Коли Ви здобули перемогу, алгоритм непомітно ще раз виконається у тестовому полігоні зі статичними умовами, котрі були підібрані мною для найбільшого балансу.<br>2. Результат виконання буде записан у браузері для майбутнього порівняння</span>`,
